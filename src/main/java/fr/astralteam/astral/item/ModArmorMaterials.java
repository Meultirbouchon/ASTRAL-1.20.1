...
public enum ModArmorMaterials implements ArmorMaterial {
    TITANIUM("titanium", 22, new int[]{ 4, 6, 4, 3 }, 20, SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, () -> Ingredient.of(ModItems.TITANIUM_INGOT.get())),
    TUNGSTEN("tungsten", 26, new int[]{ 5, 7, 5, 4 }, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 1f, 0f, () -> Ingredient.of(ModItems.TUNGSTEN_INGOT.get()));
