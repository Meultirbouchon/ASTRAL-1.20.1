...
import fr.astralteam.astral.block.entity.RefineryBlockEntity;
...
public class RefineryMenu extends AbstractContainerMenu {
    ...
    public RefineryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 117, 17));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 80, 54));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.REFINERY.get());
    }
